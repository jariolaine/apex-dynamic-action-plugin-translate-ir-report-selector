...
--   Date and Time:   19:48 Friday September 24, 2021
--   Exported By:     JLAINE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20210924194707'
...
wwv_flow_api.create_translation(
 p_id=>wwv_flow_api.id(36321145640177266046)
,p_translated_flow_id=>192102
,p_translate_to_id=>wwv_flow_api.id(166403411937284833797.192102)
,p_translate_from_id=>wwv_flow_api.id(166403411937284833797)
...
,p_last_upd_yyyymmddhh24miss=>'20210924193015'
);
...
,p_plug_template=>wwv_flow_api.id(31621431967246255320)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(36287593412247641545)
,p_name=>'Process IG'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(36287591587382641526)
,p_bind_type=>'bind'
,p_bind_event_type=>'NATIVE_IG|REGION TYPE|interactivegridselectionchange'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(36287593513189641546)
,p_event_id=>wwv_flow_api.id(36287593412247641545)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'PLUGIN_FI.JARIS.TRANSLATE_IR_REPORT_SELECTOR'

...
--   Date and Time:   04:31 Monday September 27, 2021
--   Exported By:     JLAINE
--   Flashback:       0
...
,p_last_upd_yyyymmddhh24miss=>'20210927043111'
...
wwv_flow_api.create_translation(
 p_id=>wwv_flow_api.id(36686035312742171597)
,p_translated_flow_id=>192102
,p_translate_to_id=>wwv_flow_api.id(312299044903897740419.192102)
,p_translate_from_id=>wwv_flow_api.id(312299044903897740419)
...
'Then the report names of the IR report selector are also translated according to the selected language.'))
,p_last_updated_by=>'jlaine'
,p_last_upd_yyyymmddhh24miss=>'20210927042816'
);
